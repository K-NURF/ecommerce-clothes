    ...
    <div class="wrapper">
        <header>
            ...
            <nav>
                ...
                <ul>
                    <li><a href="login.php" target = "_blank" title = "Shopping Cart"><img src = "resources/shopping-cart-empty-side-view.png" class = "icons"></a></li>
                    <li><a href="login.php" target = "_blank" title = "Login"><img src = "resources/user.png" class = "icons"></a></li>
                </ul>
