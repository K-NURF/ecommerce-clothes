...
<body>
    <div class="wrapper">
        <header>
            ...
            <svg class="mobile-icon glass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.513 55.517">
        ...
        <section class="selections">
            ...
            <ul>
                <li class="women">
                    <p><a href="women_home.php">Women</a></p>
                ...
                <li class="girls">
                    <p><a href="girls_home.php">Girls</a></p>
                ...
                <li class="boys">
                    <p><a href="boys_home.php">Boys</a></p>
